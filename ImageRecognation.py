...
def main():
    ...
    path = r"C:\Users\odemirelnt\Desktop\381_Okan_Demirel_Notebook\PYTHON\Image\total"

    for imageName in os.listdir(path):
        inputPath = os.path.join(path, imageName)
        pics = Image.open(inputPath)

        text = pytesseract.image_to_string(pics, lang="tur", config=myconfig)
